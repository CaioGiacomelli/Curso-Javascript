(function ($){ //protege a variavel dolar de ser definida em outro lugar do codigo
    $.fn.temporizador = function (opcoes){
        const opcoesFinais = $.extend({ // o que nao tiver presente em opcoes, ele vai assumar o valor do objeto do extend como padrao
            mensagem: 'Em breve!',
            horario: '23:59:59'
        }, opcoes)
